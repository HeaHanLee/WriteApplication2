...
public class Writer_Main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_writer_main);
        ...
        DatabaseReference databaseReference = database.getReference("Writer"); //DB 테이블 연결
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Writer_Main.this,Frag_Main.class);
